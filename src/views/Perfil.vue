  ...
  <div class="perfil-page">
    ...
    <div class="perfil-content">
      ...
      <div class="perfil-grid">
        ...
        <div class="card">
          <div class="card-title"><span>👤</span> Información Personal</div>
          <div class="info-rows">
            <div class="info-row">
        ...
        <!-- Cambiar nombre -->
        <div class="card">
          <div class="card-title"><span>✏️</span> Cambiar Nombre</div>

          <div v-if="!editandoNombre" class="nombre-display">
            <div class="nombre-actual">
              <span class="nombre-text">{{ nombre }}</span>
              <button class="btn-editar" @click="editandoNombre = true">✏️ Editar</button>
            </div>
        ...
        <div class="card card-full">
          <div class="card-title"><span>🔒</span> Cambiar Contraseña</div>
...
<style scoped>
.perfil-page { background: #f4f7f6; min-height: 100vh; display: flex; flex-direction: column; }
.perfil-content { padding: 0 28px 32px; flex: 1; }

.perfil-hero { background: white; border-radius: 20px; padding: 28px 32px; display: flex; align-items: center; gap: 24px; margin-bottom: 24px; box-shadow: 0 2px 12px rgba(0,0,0,0.04); }
...
.hero-info h2 { margin: 0 0 8px 0; font-size: 1.4rem; color: #1a1a2e; }
...
.rol-admin { background: #fff3e0; color: #ff8c00; }
.rol-vecino { background: #e3f2fd; color: #3b82f6; }

.perfil-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 20px; }
.card-full { grid-column: 1 / -1; }

.card { background: white; border-radius: 20px; padding: 28px; box-shadow: 0 2px 12px rgba(0,0,0,0.04); }
.card-title { font-size: 1rem; font-weight: 700; color: #1a1a2e; margin-bottom: 20px; display: flex; align-items: center; gap: 8px; }
...
.info-value { font-size: 0.88rem; color: #1a1a2e; font-weight: 600; }
...
.nombre-actual { display: flex; justify-content: space-between; align-items: center; background: #f9fafb; border-radius: 12px; padding: 14px 16px; }
.nombre-text { font-size: 1rem; font-weight: 600; color: #1a1a2e; }
.btn-editar { background: none; border: 1px solid #e5e7eb; padding: 6px 14px; border-radius: 8px; cursor: pointer; font-size: 0.82rem; color: #6b7280; transition: all 0.15s; }
...
.form-input { width: 100%; padding: 12px 16px; border-radius: 12px; border: 1.5px solid #e5e7eb; background: #fafafa; font-family: inherit; font-size: 0.92rem; outline: none; box-sizing: border-box; transition: border-color 0.2s; }
.form-input:focus { border-color: #ff8c00; background: white; }
...
.btn-cancel { flex: 1; padding: 12px; background: #f3f4f6; border: none; border-radius: 12px; font-weight: 600; cursor: pointer; color: #6b7280; }
